...
<style>
	...
	body {
              background-image: url("images/Apartment-buildings-construction-Cambridge-Eng.jpg");
...
<h2 align="center"><font><strong>Civil Construction </strong></font></h2>
...
String  sql1= "select * from pastproject where Type= 'Civil Construction' ";
